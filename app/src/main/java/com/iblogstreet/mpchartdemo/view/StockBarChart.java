 ...
 */
public class StockBarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public StockBarChart(Context context) {
        super(context);
    }

    public StockBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StockBarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new OffsetBarRenderer(this, mAnimator, mViewPortHandler);

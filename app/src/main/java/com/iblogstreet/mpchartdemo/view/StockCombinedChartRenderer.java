 ...
 */
public class StockCombinedChartRenderer extends DataRenderer {
    ...
    public StockCombinedChartRenderer(StockCombinedChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
    ...
    public void createRenderers() {
        ...
        StockCombinedChart chart = (StockCombinedChart) mChart.get();
        if (chart == null)
            return;

        StockCombinedChart.DrawOrder[] orders = chart.getDrawOrder();

        for (StockCombinedChart.DrawOrder order : orders) {
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (DataRenderer renderer : mRenderers) {
            ...
            if (renderer instanceof OffsetBarRenderer) {
                data = ((OffsetBarRenderer) renderer).mChart.getBarData();

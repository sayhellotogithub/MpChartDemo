...
import com.github.mikephil.charting.renderer.StockCombinedChartRenderer;
 ...
 */
public class StockCombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
    ...
    public StockCombinedChart(Context context) {
        super(context);
    }

    public StockCombinedChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StockCombinedChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setData(CombinedData data) {
        super.setData(data);
        setHighlighter(new CombinedHighlighter(this, this));
        ((StockCombinedChartRenderer)mRenderer).createRenderers();
